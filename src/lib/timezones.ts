...
export type AirportCode = keyof typeof airportTimezoneMap;

export async function getAirportTimezone(airportCode: AirportCode) {
  return airportTimezoneMap[airportCode];
}
